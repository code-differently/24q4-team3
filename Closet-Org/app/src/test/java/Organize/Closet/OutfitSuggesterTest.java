...
class OutfitSuggesterTest {
  ...
  void testSuggestOutfitForSunnyWeather() {
    ...
    ArticleOfClothing tShirt =
        createMockClothing("T-shirt", "Blue", "Summer", "V-Neck", "Everyday");
    ArticleOfClothing jacket = createMockClothing("Jacket", "Black", "Winter", "Heavy", "Outdoor");

    when(closet.getArticleOfClothingBySeasonalPurpose("Summer"))
        .thenReturn(List.of(tShirt, jacket));
  ...
  void testSuggestOutfitForRainyWeather() {
    ...
    // Define sample clothing items in closet
    ArticleOfClothing rainJacket =
        createMockClothing("Rain Jacket", "Black", "Spring", "Waterproof", "Outdoor");
    ArticleOfClothing sunglasses =
        createMockClothing("Sunglasses", "Black", "Summer", "Wire Frame", "Outdoor");

    when(closet.getArticleOfClothingBySeasonalPurpose("Spring"))
        .thenReturn(List.of(rainJacket, sunglasses));
  ...
  void testSuggestOutfitForSnowyWeather() {
    ...
    // Define sample clothing items in closet
    ArticleOfClothing winterCoat =
        createMockClothing("Winter Coat", "Blue", "Winter", "Warm", "Outdoor");
    ArticleOfClothing tShirt = createMockClothing("T-shirt", "Red", "Summer", "Casual", "Indoor");

    when(closet.getArticleOfClothingBySeasonalPurpose("Winter"))
        .thenReturn(List.of(winterCoat, tShirt));
  ...
  private ArticleOfClothing createMockClothing(
      String name, String color, String season, String style, String occasion) {
