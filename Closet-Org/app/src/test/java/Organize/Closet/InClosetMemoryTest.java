...
class InClosetMemoryTest {
  ...
  void testAddArticleOfClothing() {
    ArticleOfClothing outerwearItem =
        new ArticleOfClothing() {
          @Override
          public String getName() {
            return "Hoodie";
  ...
  void testUpdateArticleOfClothing() {
    ArticleOfClothing updatedFullBodyItem =
        new ArticleOfClothing() {
          @Override
          public String getName() {
            return "Dress";
  ...
  void testGetArticleOfClothingByOccasion() {
    List<ArticleOfClothing> everydayCasualClothing =
        closet.getArticleOfClothingByOccasion("Everyday Casual");
