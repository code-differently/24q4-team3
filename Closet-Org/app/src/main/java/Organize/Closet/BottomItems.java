...
public class BottomItems implements Bottoms {
    ...
    public BottomItems(String name, String color, String style, String occassion, String seasonalPurpose, String waistLine, boolean hasPockets,String bottomLength) {
        this.name = name;
        this.color = color;
        this.style = style;
