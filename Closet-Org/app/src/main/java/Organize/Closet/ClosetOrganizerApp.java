...
public class ClosetOrganizerApp {
  ...
  public static void main(String[] args) {
    ...
    closet.addArticleOfClothing(
        new TopItems(
            "Shirt", "Blue", "Polo", "Everyday Casual", "Summer", false, null, null, null, false));
    closet.addArticleOfClothing(
        new OuterwearItems("Black", "Poncho", "Rain-Jacket", "Outdoor", "Rainy Weather", null));
    closet.addArticleOfClothing(
        new AccessoriesItems("Pink", "Plastic Frame", "Sunglasses", "Outdoor", "Summer", null));
    closet.addArticleOfClothing(
        new BottomItems("Jeans", "Blue", "Capri", "Everyday Casual", "Summer", null, false, null));
    closet.addArticleOfClothing(
        new FullbodyItem(
            "Romper",
            "White",
